package io.metaray.jvm.config;

import java.time.Duration;
import java.util.Objects;

public final class JvmTransportConfig {
  public final Duration connectTimeout;
  public final Duration requestTimeout;
  public final int multicastLocalPort;

  public JvmTransportConfig(Duration connectTimeout, Duration requestTimeout, int multicastLocalPort) {
    this.connectTimeout = requirePositive(connectTimeout, "connectTimeout");
    this.requestTimeout = requirePositive(requestTimeout, "requestTimeout");
    this.multicastLocalPort = requirePort(multicastLocalPort, "multicastLocalPort");
  }

  public static JvmTransportConfig defaults() {
    return new JvmTransportConfig(Duration.ofSeconds(3), Duration.ofSeconds(5), 0);
  }
