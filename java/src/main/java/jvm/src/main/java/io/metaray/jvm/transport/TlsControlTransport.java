...
/**
 * JVM TLS control transport with length-prefixed request/response frames.
 *
...
public final class TlsControlTransport implements ControlTransport {
  ...
  public TlsControlTransport(InetSocketAddress endpoint) {
    this(
        ...
        JvmExecutors.newCachedIoExecutor("metaray-jvm-tls-control-io"),
        true
    );
  }

  public TlsControlTransport(InetSocketAddress endpoint, JvmTransportConfig config) {
    this(
        endpoint,
