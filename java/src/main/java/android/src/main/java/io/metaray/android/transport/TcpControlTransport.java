...
/**
 * Android TCP control transport with length-prefixed request/response framing.
 *
...
public final class TcpControlTransport implements ControlTransport {
  ...
  public TcpControlTransport(InetSocketAddress endpoint) {
    this(
        ...
        AndroidExecutors.newCachedIoExecutor("metaray-android-control-io"),
        true
    );
  }

  public TcpControlTransport(InetSocketAddress endpoint, AndroidTransportConfig config) {
    this(
        endpoint,
