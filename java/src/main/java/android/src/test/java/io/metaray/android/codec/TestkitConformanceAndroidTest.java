...
public final class TestkitConformanceAndroidTest {
  @Test
  @SuppressWarnings({"rawtypes", "unchecked"})
  public void testkitGoldenParityValidatesWirePayloadAcrossCodecs() {
  ...
  @Test
  public void malformedMapFuzzRejectsInvalidWireShapes() {
